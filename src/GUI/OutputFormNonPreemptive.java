...
public class OutputFormNonPreemptive extends JFrame {
	...
	public OutputFormNonPreemptive(ArrayList<Process> Processes, ArrayList<Process> Order, ArrayList<Integer> Timeline) {
